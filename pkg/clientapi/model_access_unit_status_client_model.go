...
// checks if the AccessUnitStatusClientModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessUnitStatusClientModel{}
...
// NewAccessUnitStatusClientModel instantiates a new AccessUnitStatusClientModel object
...
// NewAccessUnitStatusClientModelWithDefaults instantiates a new AccessUnitStatusClientModel object
...
func (o *AccessUnitStatusClientModel) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAccessUnitStatusClientModel := _AccessUnitStatusClientModel{}

	err = json.Unmarshal(bytes, &varAccessUnitStatusClientModel)

	if err != nil {
		return err
	}

	*o = AccessUnitStatusClientModel(varAccessUnitStatusClientModel)

	return err
}

type NullableAccessUnitStatusClientModel struct {
	value *AccessUnitStatusClientModel
	isSet bool
}
...
func NewNullableAccessUnitStatusClientModel(val *AccessUnitStatusClientModel) *NullableAccessUnitStatusClientModel {
	return &NullableAccessUnitStatusClientModel{value: val, isSet: true}
}
