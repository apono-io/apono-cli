...
type ApiSendMessageToIntentAnalyzerRequest struct {
	ctx                          context.Context
	ApiService                   *AccessAssistantAPIService
	assistantMessageRequestModel *AssistantMessageRequestModel
}

func (r ApiSendMessageToIntentAnalyzerRequest) AssistantMessageRequestModel(assistantMessageRequestModel AssistantMessageRequestModel) ApiSendMessageToIntentAnalyzerRequest {
	r.assistantMessageRequestModel = &assistantMessageRequestModel
	return r
}

func (r ApiSendMessageToIntentAnalyzerRequest) Execute() (*AssistantMessageResponseClientModel, *http.Response, error) {
	return r.ApiService.SendMessageToIntentAnalyzerExecute(r)
}

/*
SendMessageToIntentAnalyzer Send Message to intent analyzer

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiSendMessageToIntentAnalyzerRequest
*/
func (a *AccessAssistantAPIService) SendMessageToIntentAnalyzer(ctx context.Context) ApiSendMessageToIntentAnalyzerRequest {
	return ApiSendMessageToIntentAnalyzerRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return AssistantMessageResponseClientModel
func (a *AccessAssistantAPIService) SendMessageToIntentAnalyzerExecute(r ApiSendMessageToIntentAnalyzerRequest) (*AssistantMessageResponseClientModel, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessAssistantAPIService.SendMessageToIntentAnalyzer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/client/v1/assistant/intent-analyzer/chat"
