...
// checks if the PaginatedClientResponseModelResourceClientModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedClientResponseModelResourceClientModel{}
...
type _PaginatedClientResponseModelResourceClientModel PaginatedClientResponseModelResourceClientModel

// NewPaginatedClientResponseModelResourceClientModel instantiates a new PaginatedClientResponseModelResourceClientModel object
...
func NewPaginatedClientResponseModelResourceClientModel(data []ResourceClientModel, pagination PaginationClientInfoModel) *PaginatedClientResponseModelResourceClientModel {
	this := PaginatedClientResponseModelResourceClientModel{}
	this.Data = data
	this.Pagination = pagination
	return &this
}

// NewPaginatedClientResponseModelResourceClientModelWithDefaults instantiates a new PaginatedClientResponseModelResourceClientModel object
...
func (o *PaginatedClientResponseModelResourceClientModel) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPaginatedClientResponseModelResourceClientModel := _PaginatedClientResponseModelResourceClientModel{}

	err = json.Unmarshal(bytes, &varPaginatedClientResponseModelResourceClientModel)

	if err != nil {
		return err
	}

	*o = PaginatedClientResponseModelResourceClientModel(varPaginatedClientResponseModelResourceClientModel)

	return err
}

type NullablePaginatedClientResponseModelResourceClientModel struct {
	value *PaginatedClientResponseModelResourceClientModel
	isSet bool
}
...
func NewNullablePaginatedClientResponseModelResourceClientModel(val *PaginatedClientResponseModelResourceClientModel) *NullablePaginatedClientResponseModelResourceClientModel {
	return &NullablePaginatedClientResponseModelResourceClientModel{value: val, isSet: true}
}
